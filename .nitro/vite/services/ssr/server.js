...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Dicykr-J.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-B_zlQCx7.js").then((n2) => n2.r);
