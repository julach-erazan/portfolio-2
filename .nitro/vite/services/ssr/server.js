...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-mJp2EXIJ.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-BCwdCvGK.js").then((n2) => n2.r);
