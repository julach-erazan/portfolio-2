...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BzWXjz87.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-DutFq3Ie.js").then((n2) => n2.r);
