  ...
  return (
    <div className="text-white min-h-screen">
      ...
      <div className="relative z-10">
          ...
          <div className="flex-1 flex flex-col items-center justify-center container mx-auto grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center z-10">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4 items-center">
                ...
                <a
                  href="/_Julach_Earzan_Software-Engineer.pdf"
            ...
            >
              ...
              <img
                src="/Gemini_Generated_Image_csr5etcsr5etcsr5 (1).png"
        ...
        <section
          id="about"
          className="py-12 sm:py-16 px-4 sm:px-6 bg-white/[0.02]"
        >
          <div className="container mx-auto grid lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-20 items-center">
            <div className="relative max-w-[280px] sm:max-w-[320px] md:max-w-[380px] lg:max-w-[420px] mx-auto lg:mx-0">
              ...
              <img
                src="/Gemini_Generated_Image_cweza7cweza7cwez.png"
        ...
        <section id="projects" className="pb-12 sm:pb-16 px-4 sm:px-6">
          ...
          <ProjectSlider
            projects={[
              {
                title: 'Agricultural Pest Chatbot',
                description:
                  'Final Year Project integrating ReactJS, Node.js, and Flask with a CNN model for image recognition.',
                tags: ['React', 'Node.js', 'Flask', 'CNN', 'ML'],
                link: 'https://github.com/julach-erazan/Final-Project',
              },
              {
                title: "Travel Website 'Paradise Tour'",
                description:
                  'A full-featured travel exploration platform built with Next.js and Nodemailer integration.',
                tags: ['Next.js', 'Tailwind', 'Nodemailer'],
                link: 'https://github.com/julach-erazan/paradise-tours-nextjs',
              },
              {
                title: 'Weather App Website',
                description:
                  'Real-time 7-day weather forecast application with dynamic iconography and responsive design.',
                tags: ['ReactJS', 'Redux', 'Tailwind'],
                link: 'https://github.com/julach-erazan/weather-app-reactjs',
              },
              {
                title: 'Student Management System',
                description:
                  'Robust management solution with Google Auth and MongoDB integration for high scalability.',
                tags: ['ReactJS', 'Node.js', 'MongoDB', 'Google Auth'],
                link: 'https://github.com/julach-erazan/Student-Management-System-MERN-',
              },
            ]}
          />
        </section>
        ...
        {/* Footer */}
        <footer className="pb-10 sm:pb-16 border-t border-white/5 text-center">
